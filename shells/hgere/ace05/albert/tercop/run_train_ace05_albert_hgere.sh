...
for lr1 in 1e-4; do
for seq in 256; do
for entdim in 768; do
for reldim in 768; do 
...
CUDA_VISIBLE_DEVICES=$GPU_ID  python  run_hgnn.py  --model_type alberthyper  \
    ...
    --output_dir saves/HGERE/ace05re_models/albert/$factor/facenc$facenc-seq$seq-mem$memdim-iter$iter-layernorm+_attnself/ent$entdim-rel$reldim-lr$lr-$lr1-bs$bs-ep$epoch-eps$eps/Hyper_ace05_albert-$seed  --overwrite_output_dir  \
