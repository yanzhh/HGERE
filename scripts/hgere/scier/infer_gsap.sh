...
#--do_train --do_eval \
NER_PREDICTION_DIR=saves/comparison/model_scier/data_gsap/
...
CUDA_VISIBLE_DEVICES=$GPU_ID  python  run_hgnn.py  \
    ...
    --train_file ent_pred_2025-04-15_de.json \
    --dev_file ent_pred_2025-04-15_tes.json \
    --test_file ent_pred_2025-04-15_train.json \
    --model_type hyper  \
