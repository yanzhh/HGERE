...
for iter in 3; do
for eps in 1e-8; do
for loss_re_weight_alpha in 0.2 0.3; do
for epoch in 6 8; do 
#--do_train --do_eval \
NAME=${NICK_NAME}_lw-${loss_re_weight_alpha}_ep${epoch}
OUTPUT_DIR=saves/scier/HGERE/$NAME
echo $OUTPUT_DIR
#--eval_test \
CUDA_VISIBLE_DEVICES=$GPU_ID  python  run_hgnn.py  \
    ...
    --eval_dev \
    --eval_test \
    --ner_prediction_dir  saves/comparison/scier_scier/papagei/ \
